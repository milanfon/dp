const {updateObject, URLBuilder, checkNumericArray, objectsEqual, ArrayNotNumericError} = require('../inputs/js-e');
...
describe('checkNumericArray', () => {
  it('should not accept string representations of numbers', () => {
    ...
    expect(() => checkNumericArray(array)).not.toThrow(ArrayNotNumericError);
  });
});
