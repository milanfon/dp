...
\chapter{Úvod}
    ...
    %TODO Co to jsou SW testy, proč se dělají, jak se dělají, specifikace, druhy, příklad

    \section{Jazykové modely}

    %TODO Co to je LLM, jak fungují
