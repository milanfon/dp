...
\chapter{Úvod}
    ...
    Testy se v softwarovém vývoji rozdělují na různé druhy dle jejich specifického zaměření a rozsahu. Mezi nejčastější druhy se řadí:
    \begin{itemize}
    ...
    %TODO Co to jsou SW druhy, příklad, asi i to GUI testování a jak probíhá automatizovaně
