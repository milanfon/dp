...
${MY EXAMS PAGE} http://localhost:4680/tbuis/student-view/myExamDates \end{code}
        ...
        Jedním z modelů, který společnost \textit{Mistral} nabízí je poměrně malý model \textbf{Mistral 22B}, nyní ve verzi \textit{0.2}. Tento model však nebyl schopen vygenerovat ani jeden validní test dle výsledků v obr. \ref{fig:res:mistral-22b}. Primárními problémy zde byly:
        \begin{itemize}
...
...
        ...
        \begin{figure}
            ...
            \caption{Výsledky pro model Mistral 22B v0.2}
            \label{fig:res:mistral-22b}
        \end{figure}
