...
${MY EXAMS PAGE} http://localhost:4680/tbuis/student-view/myExamDates
        ...
        Jedním z modelů, který společnost \textit{Mistral} nabízí je poměrně malý model \textbf{Mistral 22B}, nyní ve verzi \textit{0.2}. I přes jeho nižší počet parametrů je však schopen vygenerovat více validních testů než větší modely jako například \textit{GPT-3.5 Turbo} nebo \textit{Llama 3} dle výsledků v obr. \ref{fig:res:mistral-22b}. I přes tento fakt však model nebyl schopen vytvořit ani jednu variantu odpovídají požadavkům pro testy: 1, 4, 9 a 11. Primárními problémy zde byly:
        \begin{itemize}
...
...
        ...
        \noindent Nejvíce validních variant testu byl model schopen vygenerovat pro specifikaci 6.
