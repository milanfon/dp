...
`\uxprompt`python3 stats.py ../results/claude-3-opus-run.sqlite -t "Claude 3 Opus" -e claude-results.pdf
        ...
        %TODO Dopsat a asi ty konkrítní výsledky dát do přílohy, nebo je jen referovat a přidat i referenci na akceptační testy samostatného projektu a jejich výsledky
