...
{% include 'recording-spec-18.json' %}
    ...
    \section{Dotazování LLM}
        ...
        \end{itemize}
        Ukázkové volání lze vidět v ukázce \ref{con:generation}. Program je schopen vygenerovat pro jeden test více variant na bázi stejného promptu (vytváření nových dotazů na \Gls{llm}). 
        % TODO Schéma práce s promptem
