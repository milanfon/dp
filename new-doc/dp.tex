    ...
    \section{Dotazování LLM}
        ...
        \subsection{Modely a jejich spuštění}
            ...
            \begin{table}
                \begin{tabular}{|c|c|c|}
                    \hline
                    \textbf{Model} & \textbf{Použitá verze} & \textbf{Runtime} \\
                    \hline
                    GPT-4 & gpt-4-32k & API  \\
                    \hline
                    % TODO Dopsat modely
            ...
            \subsubsection{Prostředí pro lokální modely}

            Pro \emph{lokální} modely a jejich spuštění byl využit software \textit{LM Studio}, který je postaven nad \textit{C++} knihovnou \verb|llama.cpp|. Ta umožňuje jednoduché spuštění \Gls{llm} modelů ve formátu \textit{GGUF}. 

            % TODO nějaký popis GGUF
            % TODO obr LM Studia
