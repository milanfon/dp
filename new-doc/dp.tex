...
Navigate To My Subjects And Verify
    ...
    Element Should Be Visible    xpath=//*[@id="tea.mySubjects.successAlert"]
        ...
        \subsection{Anthropic}
            ...
            Testovaný model \textbf{Claude 3 Opus} od společnosti Anthropic byl schopen pro každý test vygenerovat nejméně jednu variantu, která je schopna odhladit každou chybu vloženou do systému (obr. \ref{fig:res:claude-3-opus}).
