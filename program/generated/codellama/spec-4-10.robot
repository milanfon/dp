...
Spec 4 Teacher
    ...
    Click Element    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]
    Click Element    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]
    Element Text Should Be    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]    33
    Click Element    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]
    Click Element    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]
    Element Text Should Be    xpath://*[@id="tea.setEvaluation.form.examTermDateSelect"]    35
    Click Element    xpath://*[@id="tea.menu.evaluationTable"]
    Click Element    xpath://*[@id="tea.evalTable.filter.subjectSelect"]
    Input Text    xpath://*[@id="tea.evalTable.filter.subjectSelect"]    3
    Click Element    xpath://*[@id="tea.evalTable.filter.subjectSelect"]
    Click Element    xpath://*[@id="tea.evalTable.filter.subjectSelect"]
    Element Text Should Be    xpath://*[@id="tea.evalTable.filter.subjectSelect"]    -1
    Click Element    xpath://*[@id="tea.evalTable.filter.submitButton"]
    Element Text Should Be    xpath://*[@id="tea.evalTable.form.noOneStudent"]    No students on this exam date
    Close Browser