...
Open University Information System And Unenroll Subject
    ...
    Sleep    2s
    Check If Element Has Background Color #007bff

*** Keywords ***
Check If Element Has Background Color #007bff
    ${background_color}    Get Element Css Value    ${MY_SUBJECTS_LINK_XPATH}    background-color
    Should Be Equal    ${background_color}    #007bff
